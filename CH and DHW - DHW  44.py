...
# TEST
Test_title = 'CH and DHW - DHW / 44'     # HERE THE NAME OF THE CASE
Test_case = "C272652"      # HERE THE ID OF THE CASE
Script_Ver = "1"
Framework_Ver = "1.6.0"
Class_Ver = "1.4.0"

Link_TC_LL = "https://comodel.mtsintra.network/testrail/index.php?/cases/view/272652"       # HERE THE LINK OF THE TC LL
...
SOURCE = "WHB"
CH_DHW_2 = "CH"                    # STEP 2: Can be "CH" if we want disable the source for CH or "DHW" if we want disable the source for DHW
...
if em.read_DGTO("HEM - Status") == 190 and em.check_Loads():
    ...
    if hem_status_2 == STATUS_2 and current_cycle_2 == CYCLE_2 and macro_2 == MACROSTATE_2 and em.check_Loads(hp_available=False, aux_available=False):
